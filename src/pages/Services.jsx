...
const services = [
  {
    ...
    description:
      'Building responsive, interactive user interfaces with HTML, CSS, JavaScript, TypeScript, and React for seamless user experiences.',
  },
  {
      ...
      <section className="px-6 md:px-[9%] pt-24 pb-16 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-6xl">
          {services.map((service, index) => (
            <div
              key={service.title}
              className="bg-gray-900 p-6 rounded-2xl border-2 border-[var(--main-color)] text-center hover:scale-105 hover:shadow-[0_0_20px_var(--main-color)] transition-all duration-300 ease-in-out"
